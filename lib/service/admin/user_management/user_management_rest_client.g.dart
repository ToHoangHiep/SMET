...
part of 'user_management_rest_client.dart';
...
class _UserManagementRestClient implements UserManagementRestClient {
  _UserManagementRestClient(this._dio, {this.baseUrl, this.errorLogger});
