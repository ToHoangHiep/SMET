...
class MentorCourseReportDetailWeb extends StatelessWidget {
  ...
  const MentorCourseReportDetailWeb({super.key, this.courseId});
              ...
              children: [
                SharedBreadcrumb(
                  items: const [
                    ...
                    BreadcrumbItem(label: 'Báo cáo', route: '/mentor/course-report'),
                    BreadcrumbItem(label: 'Chi tiết khóa học'),
                  ],
        ...
        Container(
          ...
          child: const Row(
            children: [
              ...
              Spacer(),
              Text('Hướng dẫn Mentor', style: TextStyle(color: Color(0xff64748B))),
              SizedBox(width: 24),
              Text('Quy trình chấm bài', style: TextStyle(color: Color(0xff64748B))),
              SizedBox(width: 24),
              Text('Hỗ trợ kỹ thuật', style: TextStyle(color: Color(0xff64748B))),
              SizedBox(width: 24),
              Text('© 2024 SMETS Academic Curator.',
  ...
  Widget build(BuildContext context) {
    return const Row(
      children: [
        ...
        SizedBox(width: 12),
        Text('Lớp: ', style: TextStyle(fontSize: 14, color: Color(0xff64748B))),
        Text(
          'UIUX-ADV-01',
          style: TextStyle(fontSize: 14, color: Color(0xff181C22), fontWeight: FontWeight.bold),
        ),
        Text(' • Mentor: ', style: TextStyle(fontSize: 14, color: Color(0xff64748B))),
        Text(
          'Trần Hoàng Minh',
          style: TextStyle(fontSize: 14, color: Color(0xff181C22), fontWeight: FontWeight.bold),
        ),
