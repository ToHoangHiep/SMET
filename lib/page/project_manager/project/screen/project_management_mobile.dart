...
class ProjectManagementMobile extends StatelessWidget {
  ...
  Widget _buildDrawer(BuildContext context) {
    return Drawer(
      child: ListView(padding: EdgeInsets.zero, children: [
        ...
        ListTile(leading: const Icon(Icons.folder), title: const Text('Dự án'), selected: true, onTap: () => Navigator.pop(context)),
