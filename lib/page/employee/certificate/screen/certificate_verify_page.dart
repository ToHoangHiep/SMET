...
class _CertificateVerifyPageState extends State<CertificateVerifyPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return _CertificateVerifyMobile(
      code: widget.code,
      certificate: _certificate,
      isLoading: _isLoading,
      notFound: _notFound,
...
class _CertificateVerifyWeb extends StatelessWidget {
  final String code;
            ...
            child: Column(
              ...
              children: [
                if (isLoading) ...[
                  ...
                  _buildInvalidCardWeb(),
                ] else if (certificate != null) ...[
                  _buildVerifiedCardWeb(certificate!),
                ],
              ],
            ),
          ),
  ...
  Widget _buildVerifiedCardWeb(CertificateInfo cert) {
    return Container(
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(16),
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        'Ngày cấp: ${_formatDateWeb(cert.issuedAt)}',
                ...
                SizedBox(
                  width: double.infinity,
                  child: ElevatedButton.icon(
                    onPressed: isViewingWeb ? null : onView,
                    icon: isViewingWeb
                        ? const SizedBox(width: 18, height: 18, child: CircularProgressIndicator(strokeWidth: 2, color: Colors.white))
                        : const Icon(Icons.picture_as_pdf, size: 20),
                    label: Text(
                      isViewingWeb ? 'Đang mở...' : 'Xem chứng chỉ PDF',
  ...
  String _formatDateWeb(DateTime date) =>
      '${date.day.toString().padLeft(2, '0')}/${date.month.toString().padLeft(2, '0')}/${date.year}';

  bool get isViewingWeb => isViewing;
}

class _CertificateVerifyMobile extends StatelessWidget {
  final String code;
  final CertificateInfo? certificate;
  final bool isLoading;
  final bool notFound;
  ...
  const _CertificateVerifyMobile({
    required this.code,
    required this.certificate,
    required this.isLoading,
    required this.notFound,
            ...
            child: Column(
              ...
              children: [
                if (isLoading) ...[
                  ...
                  _buildInvalidCardMobile(),
                ] else if (certificate != null) ...[
                  _buildVerifiedCardMobile(certificate!),
                ],
              ],
            ),
          ),
  ...
  Widget _buildInvalidCardMobile() {
    return Container(
      padding: const EdgeInsets.all(24),
      decoration: BoxDecoration(
        color: Colors.white,
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Icon(Icons.gpp_bad, color: Colors.red.shade400, size: 40),
          ),
  ...
  Widget _buildVerifiedCardMobile(CertificateInfo cert) {
    return Container(
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(16),
        gradient: const LinearGradient(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: Text(
                      isViewing ? 'Đang mở...' : 'Xem chứng chỉ PDF',
                      style: const TextStyle(fontWeight: FontWeight.w600),
                    ),
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Colors.white,
